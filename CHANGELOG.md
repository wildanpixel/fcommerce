...
- Added explicit `height: 100%` sizing to the Electron `webview` shadow-root iframe and extended the fullscreen regression test to verify the rendered browser surface height and internal iframe style.
