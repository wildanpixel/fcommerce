...
- Added explicit `height: 100%` iframe sizing alongside the embedded browser webview sizing and extended the fullscreen regression test to verify the rendered browser surface height.
